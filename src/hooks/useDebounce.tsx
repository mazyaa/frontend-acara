...
const useDebounce = () => {
    ...
    const debounce = (func: Function, delay: number) => {
        if (debounceTimeout.current) { // for clear previous timeout ex. if user typing a, b, c it will clear previous timeout for a and b so only c will be executed (result is: abc will be executed after delay)
