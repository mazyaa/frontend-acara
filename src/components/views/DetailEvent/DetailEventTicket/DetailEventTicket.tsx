    ...
    <Card className="px-4 pb-4" key={key}>
      <Accordion>
        <AccordionItem
          ...
          className="border-b-2 border-dashed border-foreground-300"
          title={
      ...
      <div className="mt-2 flex items-center justify-between p-2">
        ...
        {session.status === "authenticated" && Number(ticket.quantity) > 0 && (
          <Button
            ...
            color="warning"
            variant="bordered"
            className="font-bold text-warning disabled:text-foreground-300 disabled:bg-foreground-100 disabled:border-foreground-100"
